...
xdescribe("createFullName() tests", function () {
...
xdescribe("findSmallestNumber() tests", function () {
  it("Should have a return", function () {
...
xdescribe("checkIfNewHighScore() tests", function () {
  it("Should have a return", function () {
...
xdescribe("celsiusToFahrenheit() tests", function () {
  it("Should have a return", function () {
